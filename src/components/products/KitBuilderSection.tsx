        ...
        <section className="relative py-20 px-4 md:px-8 overflow-hidden bg-background">
            ...
            <div className="relative max-w-[1200px] mx-auto">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-black text-white uppercase leading-tight mb-3">
                        Kit <span className="text-primary">Builder</span>
                    </h2>
                    <p className="text-muted text-sm md:text-base max-w-lg mx-auto px-4">
                        Design your team&apos;s kit from scratch. Choose your sport, pick garments, customise colours, add crests and sponsors.
                    </p>
                </motion.div>

                {/* Sport Cards Grid */}
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4 mb-10 w-full max-w-sm md:max-w-none mx-auto">
                    {SPORTS.map((sport, i) => (
                        <motion.div
                            key={sport.id}
                        ...
                        >
                            <Link
                                ...
                                className="block relative group bg-white/5 border border-white/10 rounded-xl p-4 md:p-5 text-center transition-all duration-300 overflow-hidden hover:border-primary/40"
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    <motion.div
                                        className="mb-3 text-white/70 group-hover:text-primary transition-colors duration-300 drop-shadow-[0_0_15px_rgba(255,255,255,0.05)] group-hover:drop-shadow-[0_0_15px_rgba(102,187,106,0.4)]"
                                        whileHover={{ scale: 1.1, rotate: [0, -5, 5, 0] }}
                                        transition={{ duration: 0.3 }}
                                    >
                                        {getSportIcon(sport.id, "w-9 h-9 md:w-11 md:h-11")}
                                    </motion.div>
