                    ...
                    <div className="max-w-[1600px] mx-auto px-4 md:px-8 py-3 md:py-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Link href="/" className="md:hidden">
                                <img src="/assets/af-logo.png" alt="AF Gear" className="h-10 w-auto" style={{ filter: "brightness(0) invert(1)" }} />
                            </Link>
                        </div>

                        {/* LEFT: Logo (Desktop) */}
                        <Link href="/" className="hidden md:block absolute left-8 top-1/2 -translate-y-1/2">
                            <img src="/assets/af-logo.png" alt="AF Gear" className="h-16 lg:h-20 w-auto transition-transform hover:scale-105 duration-300" style={{ filter: "brightness(0) invert(1)" }} />
                        </Link>
